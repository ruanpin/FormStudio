...
import type { Select as ISelect } from '../../../../../types/form-element';

const element = defineModel<ISelect>('element', { required: true })
</script>
    ...
    <div class="space-y-2">
      <div class="flex items-center">
        ...
        <div class="flex-ac q-ml-xs q-gutter-sm">
          <Button @click="updateOptions({ operate: 'create', target: element.options, index: element.options.length })">
            <Plus />
          </Button>
        </div>
      </div>
